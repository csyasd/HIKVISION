...
namespace YixiaoAdmin.Services
{
    ...
    {
        private ICameraRecordRepository _CameraRecordRepository;
        public CameraRecordServices(ICameraRecordRepository CameraRecordRepository)
        {
            this._CameraRecordRepository = CameraRecordRepository;
            base.baseRepository = _CameraRecordRepository;
        }
        public async Task<PagesResponse> QueryPages(QueryPageModel queryPageModel)
        {
            ...
            pagesResponse.Success((await _CameraRecordRepository.Query(whereExpression, queryPageModel.Orderby, queryPageModel.CurrentPage, queryPageModel.PageNumber)).ToList());
