...
namespace YixiaoAdmin.Services
{
    ...
    public partial class  CameraServices:BaseServices<Camera>, ICameraServices
    {
        ...
        public CameraServices(ICameraRepository CameraRepository)
        {
            this._CameraRepository = CameraRepository;
            base.baseRepository = _CameraRepository;
        }
        public async Task<PagesResponse> QueryPages(QueryPageModel queryPageModel)
        {
            ...
            pagesResponse.Success((await _CameraRepository.Query(whereExpression, queryPageModel.Orderby, queryPageModel.CurrentPage, queryPageModel.PageNumber)).ToList());
