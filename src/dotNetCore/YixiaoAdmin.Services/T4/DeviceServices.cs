...
namespace YixiaoAdmin.Services
{
    ...
    public partial class  DeviceServices:BaseServices<Device>, IDeviceServices
    {
        ...
        public DeviceServices(IDeviceRepository DeviceRepository)
        {
            ...
            base.baseRepository = _DeviceRepository;
        }
        public async Task<PagesResponse> QueryPages(QueryPageModel queryPageModel)
        {
            ...
            pagesResponse.Success((await _DeviceRepository.Query(whereExpression, queryPageModel.Orderby, queryPageModel.CurrentPage, queryPageModel.PageNumber)).ToList());
