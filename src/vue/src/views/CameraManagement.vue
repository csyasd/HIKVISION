...
<template>
    <div class="container" >
        ...
        >
            ...
            <el-table-column :show-overflow-tooltip="true" prop="DeviceCode" label="设备编码" width="220" ></el-table-column>
    
            <el-table-column :show-overflow-tooltip="true" prop="IP" label="IP地址" width="220" ></el-table-column>
        ...
        <el-dialog title="添加" :visible.sync="addDialogFormVisible">
            ...
            <el-form-item label="设备编码" :label-width="formLabelWidth">
                <el-input v-model="addForm.DeviceCode" autocomplete="off" placeholder="请输入设备编码"></el-input>
            </el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editDialogFormVisible">
            ...
            <el-form-item label="设备编码" :label-width="formLabelWidth">
                <el-input v-model="editForm.DeviceCode" autocomplete="off" placeholder="请输入设备编码"></el-input>
            </el-form-item>
...
<script>
import { SelectCamera, AddCamera, EditCamera, DeleteCamera,SelectCameraById } from "../api/api";
import{
...
export default {
    ...
    methods: {
        ...
        getTableData() {
            ...
            SelectCamera(pageData).then(res => {
        ...
        AddConfirm() {
            this.operationDisabled = true;
            AddCamera(this.addForm).then(res => {
                if (res) {
                    this.$message({
                        message: "创建成功！",
                        type: "success",
        ...
        handleEdit(row) {
               ...
               this.editForm.DeviceCode = row.DeviceCode;
        ...
        EditConfirm() {
            this.operationDisabled = true;
            EditCamera(this.editForm).then(res => {
                    if (res) {
                        this.$message({
                            message: "编辑成功！",
                            type: "success",
