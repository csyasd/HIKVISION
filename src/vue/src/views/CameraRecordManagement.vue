...
<script>
import { SelectCameraRecord, AddCameraRecord, EditCameraRecord, DeleteCameraRecord,SelectCameraRecordById } from "../api/api";
import{
...
export default {
    ...
    mounted() {
       (async () => {
            ...
            this.CameraList = await SelectALLCamera();
    ...
    methods: {
        ...
        getTableData() {
            ...
            SelectCameraRecord(pageData).then(res => {
        ...
        AddConfirm() {
            this.operationDisabled = true;
            AddCameraRecord(this.addForm).then(res => {
                if (res) {
                    this.$message({
                        message: "创建成功！",
                        type: "success",
        ...
        handleEdit(row) {
               ...
               this.editForm.CameraId = row.CameraId;
        ...
        EditConfirm() {
            this.operationDisabled = true;
            EditCameraRecord(this.editForm).then(res => {
                    if (res) {
                        this.$message({
                            message: "编辑成功！",
                            type: "success",
        ...
        handleDelete(row) {
            ...
            this.$confirm("此操作将删除该条记录, 是否继续?", "提示", {
                ...
                .then(() => {
                    DeleteCameraRecord(Data).then((res) => {
                        if (res) {
                            this.$message({
                                type: "success",
                                message: "删除成功!",
