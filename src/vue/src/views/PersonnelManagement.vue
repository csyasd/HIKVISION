 ...
 * 本文件由T4模板生成，请将本文件复制到前端YixiaoAdmin/views文件夹中使用
    * 文件名：PersonnelManagement.vue
************************************************************************/
<template>
    <div class="container" >
        <el-col :span="24" class="toolbar">
            <el-input style="width: 200px" placeholder="搜索姓名" v-model="Query[0].QueryStr"></el-input>&nbsp;&nbsp;
        ...
        >
            ...
            <el-table-column :show-overflow-tooltip="true" prop="FullName" label="姓名" width="220" ></el-table-column>
        ...
        <el-dialog title="添加" :visible.sync="addDialogFormVisible">
            ...
            <el-form-item label="工号" :label-width="formLabelWidth">
                <el-input v-model="addForm.EmployeeNumber" autocomplete="off" placeholder="请输入工号"></el-input>
            </el-form-item>

            <el-form-item label="姓名" :label-width="formLabelWidth">
                <el-input v-model="addForm.FullName" autocomplete="off" placeholder="请输入姓名"></el-input>
            </el-form-item>
        ...
        <el-dialog title="编辑" :visible.sync="editDialogFormVisible">
            ...
            <el-form-item label="工号" :label-width="formLabelWidth">
                <el-input v-model="editForm.EmployeeNumber" autocomplete="off" placeholder="请输入工号"></el-input>
            </el-form-item>

            <el-form-item label="姓名" :label-width="formLabelWidth">
                <el-input v-model="editForm.FullName" autocomplete="off" placeholder="请输入姓名"></el-input>
            </el-form-item>
...
<script>
import { SelectPersonnel, AddPersonnel, EditPersonnel, DeletePersonnel, SelectPersonnelById } from "../api/api";
...
export default {
    ...
    methods: {
        ...
        getTableData() {
            ...
            SelectPersonnel(pageData).then(res => {
        ...
        AddConfirm() {
            this.operationDisabled = true;
            AddPersonnel(this.addForm).then(res => {
                if (res) {
                    this.$message({
                        message: "创建成功！",
                        type: "success",
        ...
        EditConfirm() {
            this.operationDisabled = true;
            EditPersonnel(this.editForm).then(res => {
                    if (res) {
                        this.$message({
                            message: "编辑成功！",
                            type: "success",
